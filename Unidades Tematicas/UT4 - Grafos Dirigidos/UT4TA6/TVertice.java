...
public class TVertice implements IVertice{
   ...
   public boolean tieneCiclo(TCamino tecamino){
       this.setVisitado(true);
       for(TAdyacencia adya : this.getAdyacentes()){
           if(adya.getDestino().getVisitado()){
               if(tecamino.estaEnElCamino(adya.getDestino())){
                    return true;
               }
           }else{
               tecamino.agregarAdyacencia(adya);
               if(adya.getDestino().tieneCiclo(tecamino)){
                   return true;
               }
               tecamino.eliminarAdyacencia(adya);
           }
       }
       return false;
   }
