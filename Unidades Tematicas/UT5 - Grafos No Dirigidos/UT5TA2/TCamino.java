...
// SEA MÁS APROPIADA
    ...
    public String imprimirEtiquetas() {
        ...
        return sb.toString()+ " Costo= "+ Double.toString(r);
    }
    ...
    public boolean existe(Comparable etiqueta){
        if(this.getOrigen().getEtiqueta().equals(etiqueta)){
            return true;
        }
        else{
            for(Comparable vert : this.getOtrosVertices()){
                if(vert.equals(etiqueta)){
                    return true;
                }
            }
        }
    ...
    public int obtenerVect(){
        return otrosVertices.size();
    }
